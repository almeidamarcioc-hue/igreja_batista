          ...
          <div style={{
            ...
            <form onSubmit={handleSaveNovo} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <div>
                ...
                <input type="text" value={novoFormData.endereco} onChange={(e) => setNovoFormData({...novoFormData, endereco: e.target.value})} placeholder="Rua" style={{ width: '100%', border: '1px solid #e5e7eb', borderRadius: 6, padding: '10px 12px', fontSize: 13, boxSizing: 'border-box', fontFamily: 'inherit' }} />
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 12 }}>
                ...
                <div>
                  ...
                  <input type="text" value={novoFormData.uf} onChange={(e) => setNovoFormData({...novoFormData, uf: e.target.value})} placeholder="SP" maxLength={2} style={{ width: '100%', border: '1px solid #e5e7eb', borderRadius: 6, padding: '10px 12px', fontSize: 13, boxSizing: 'border-box', fontFamily: 'inherit' }} />
                </div>
              </div>
