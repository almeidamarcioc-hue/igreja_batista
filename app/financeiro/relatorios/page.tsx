    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-2 border-b">
        <button
          ...
          className={`px-4 py-3 font-medium border-b-2 ${activeTab === 'resumo' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-900'}`}
        >
          📊 Resumo
        </button>
        <button
          onClick={() => setActiveTab('receitas')}
          className={`px-4 py-3 font-medium border-b-2 ${activeTab === 'receitas' ? 'border-green-600 text-green-600' : 'border-transparent text-gray-900'}`}
        >
          ⬆️ Receitas
        </button>
        <button
          onClick={() => setActiveTab('despesas')}
          className={`px-4 py-3 font-medium border-b-2 ${activeTab === 'despesas' ? 'border-red-600 text-red-600' : 'border-transparent text-gray-900'}`}
        >
          ⬇️ Despesas
        </button>
        <button
          onClick={() => setActiveTab('ministerios')}
          className={`px-4 py-3 font-medium border-b-2 ${activeTab === 'ministerios' ? 'border-purple-600 text-purple-600' : 'border-transparent text-gray-900'}`}
        >
          ⛪ Ministérios
        </button>
      </div>
      ...
      {loading ? (
        <div className="bg-white p-8 rounded-lg shadow text-center text-gray-900">
        ...
        <>
          ...
          {activeTab === 'resumo' && (
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="text-lg font-bold mb-4 text-gray-900">Comparativo do Período</h3>
          ...
          {activeTab === 'receitas' && (
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="p-6 border-b">
                <h3 className="text-lg font-bold text-gray-900">Detalhamento de Receitas</h3>
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="text-right p-3 text-gray-900">Valor</th>
                  ...
                  {receitas.length === 0 ? (
                    ...
                    receitas.map((r) => (
                      <tr key={r.id} className="border-t hover:bg-gray-50">
                        <td className="p-3 text-gray-900">{r.descricao}</td>
                        <td className="p-3">
          ...
          {activeTab === 'despesas' && (
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="p-6 border-b">
                <h3 className="text-lg font-bold text-gray-900">Detalhamento de Despesas</h3>
                <p className="text-sm text-gray-900 mt-1">
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="text-left p-3 text-gray-900">Descrição</th>
                    <th className="text-left p-3 text-gray-900">Tipo</th>
                    <th className="text-left p-3 text-gray-900">Fornecedor</th>
                    <th className="text-left p-3 text-gray-900">Ministério</th>
                    <th className="text-right p-3 text-gray-900">Valor</th>
                    <th className="text-center p-3 text-gray-900">Status</th>
                  </tr>
                ...
                <tbody>
                  {despesas.length === 0 ? (
                    <tr>
                      <td colSpan={6} className="p-3 text-center text-gray-900">
          ...
          {activeTab === 'ministerios' && (
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="p-6 border-b">
                <h3 className="text-lg font-bold text-gray-900">Saúde Financeira por Ministério</h3>
                <p className="text-sm text-gray-900 mt-1">
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="text-right p-3 text-gray-900">Gasto</th>
                    <th className="text-right p-3 text-gray-900">% Utilizado</th>
                    <th className="text-center p-3 text-gray-900">Status</th>
                  </tr>
                </thead>
                <tbody>
