...
import ComunicacaoSidebar from '@/components/ComunicacaoSidebar'

export default function ComunicacaoShell({ children }: { children: React.ReactNode }) {
  const [sidebarOpen, setSidebarOpen] = useState(false)

  return (
    <>
      <ComunicacaoSidebar open={sidebarOpen} onClose={() => setSidebarOpen(false)} />
      ...
      >
        ...
        <span style={{ color: '#C5A059' }} className="text-base font-bold tracking-wide">Comunicação IBTM</span>
      </div>
